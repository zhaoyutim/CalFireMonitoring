...
if __name__ == '__main__':
    ...
    # for i, id in enumerate(ids):
        ...
        # dataset_pre.batch_downloading_from_gclound_training(satellites, '2023-04-02')
    ...
    # proj5_processor.dataset_generator_proj5_image_seqtoseq(train_ids, visualize=False, file_name='proj5_train_img_seqtoseq_'+year+'.npy', label_name='proj5_train_label_seqtoseq_'+year+'.npy', ts_length=10, interval=3, image_size=(512, 512))
    # proj5_processor.dataset_generator_proj5_image_seqtoseq(val_ids, visualize=False, file_name='proj5_val_img_seqtoseq.npy', label_name='proj5_val_label_seqtoseq.npy', ts_length=10, interval=3, image_size=(512, 512))
    # proj5_processor.dataset_generator_proj5_image_seqtoseq(test_ids, visualize=True,
    #                                                        file_name='proj5_'+test_ids[0]+'_img_seqtoseq.npy',
    #                                                        label_name='proj5_'+test_ids[0]+'_label_seqtoseq.npy',
    #                                                        image_size=(512, 512))
    ...
    # proj5_processor.dataset_generator_proj5_image_seqtoone(test_ids, visualize=False,
    #                                                        file_name='proj5_'+test_ids[0]+'_img_seqtoone.npy',
    #                                                        label_name='proj5_'+test_ids[0]+'_label_seqtoone.npy', ts_length=10,
    #                                                        interval=3, image_size=(512, 512))
